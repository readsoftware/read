  ...
  abstract class Entity {
    ...
    */
    public function getLinkedByAnnotationsByType() {
      $annotations = new Annotations("'".$this->getGlobalID()."'"." = ANY(VALUES(ano_linkto_ids)) and ano_linkfrom_ids is null and not ano_owner_id = 1","ano_type_id,modified");
      if ($annotations->getCount()>0){
    ...
    */
    public function getRelatedEntitiesByLinkType() {
      ...
      $annotations = new Annotations("'".$this->getGlobalID()."'"." = ANY(VALUES(ano_linkfrom_ids)) and ano_linkto_ids is not null and not ano_owner_id = 1 ","ano_type_id,modified");
      if ($annotations->getCount()>0){
