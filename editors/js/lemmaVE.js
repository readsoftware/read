  ...
  */
  ...
  createPOSEditUI: function () {
    var lemmaVE = this, showSub,
      ...
      listPOS = [{ label: "adj.", trmID: 674, showSub: "showSubAdj", showInfl: "showCase showAdjGender showNumber" },
      ...
      { label: "pres. part.", trmID: 678, showInfl: "showCase showAdjGender showNumber showAConj" },
      { label: "des.", trmID: 679, showInfl: "showCase showAdjGender showNumber showAConj" },
      { label: "int.", trmID: 680, showInfl: "showCase showAdjGender showNumber showAConj" }],
  ...
  createInflectionEditUI: function (infID, attestedGID, btnDiv) {
    var lemmaVE = this, showSub, nounID = 664, pronID = 667, verbID = 685, sverbDefault = 686,
      ...
      listVConj = [{ label: "caus.", trmID: 856 },
                  ...
                  { label: "int.", trmID: 859 },
                  { label: "den.", trmID: 858 }],
      listAConj = [{ label: "caus.", trmID: 856 },
                   { label: "des.", trmID: 857 },
                   { label: "int.", trmID: 859 },
                   { label: "den.", trmID: 858 }],
      listCtrl = [{ label: "Save", type: "saveBtnDiv" },
    ...
    if (pos == verbID) {
      ...
      if (lemmaShowInf.indexOf('showPerson') > -1) {
        infEdit.append(this.createRadioGroupUI("person", "PersonUI", listPerson, per, null, icf[6] == 2));
      }
