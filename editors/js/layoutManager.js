    ...
    if (entTag && entTag.length > 3 && paneID && paneID.length) {
      ...
      switch (contentType) {
        ...
        case 'cat'://dictionary or glossary
          ...
          if (catalog.value == "GD" || catalog.value == "MW" || catalog.value == "CG" || catalog.value == "MG" || catalog.value == "GARDINER") {
            ...
            } else if (catalog.value == "CG" || catalog.value == "MG" || catalog.value == "GARDINER") {
              defSrchStr = 'A';
              config['selectURL'] = basepath + '/plugins/dictionary/index.php?db=' + dbName +'&section=' + catCode + '&searchstring={{value}}&searchtype={{type}}';
            }
            config['url'] = basepath + '/plugins/dictionary/index.php?db=' + dbName +'&section=' + catCode + '&searchstring='+defSrchStr+'&searchtype=L';
